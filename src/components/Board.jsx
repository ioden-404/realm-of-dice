    ...
    for (let x = 0; x < cols; x++) {
      ...
      cells.push(
        ...
        >
          ...
          {terrainCell && (
            terrainCell.image ? (
              <img src={terrainCell.image} alt={terrainCell.label} className={`cell-terrain-img ${terrainCell.large ? 'cell-terrain-img-large' : ''} ${terrainCell.fillCell ? 'cell-terrain-img-fill' : ''}`} title={terrainCell.label} />
            ) : (
